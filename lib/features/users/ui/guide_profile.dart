...
class GuideProfilelScreen extends StatefulWidget {
  const GuideProfilelScreen({Key? key}) : super(key: key);

  @override
  State<GuideProfilelScreen> createState() => _GuideProfilelScreenState();
}

class _GuideProfilelScreenState extends State<GuideProfilelScreen> {
  @override
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  child: Row(
                      ...
                      children: [
                        Text('Nueva Guía', style: context.titleSmall)
                      ])),
              ...
              ElevatedButton(
                  ...
                  child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('Mis guias', style: context.titleSmall)
                      ])),
              const SizedBox(height: 15),
              ElevatedButton(
                  onPressed: () {
